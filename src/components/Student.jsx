      ...
      <div>
        <div className="grid grid-cols-3">
          <div className="bg-[#FFFFFF] border md:w-[364px] md:h-[270px] pl-4 py-8 ">
            ...
            <p className="text-[#1E1E1E] font-thin text- my-4">
              We are the representatives of more than 30+ <br /> universities in
              Australian countries and our <br /> admission{" "}
            </p>
